...
class StickersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sticker" do
    assert_difference('Sticker.count') do
      post stickers_url, params: { sticker: { goal_id: @sticker.goal_id, icon: @sticker.icon, rating: @sticker.rating } }
    end
  ...
  test "should update sticker" do
    patch sticker_url(@sticker), params: { sticker: { goal_id: @sticker.goal_id, icon: @sticker.icon, rating: @sticker.rating } }
